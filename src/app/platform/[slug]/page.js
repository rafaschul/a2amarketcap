...
const s = {
  ...
  hero: { marginTop: 12, border: "1px solid #22314e", background: "linear-gradient(180deg,#0b1430,#091127)", borderRadius: 16, padding: 18, display: "flex", gap: 14, alignItems: "flex-start", flexWrap: "wrap", boxShadow: "0 8px 30px rgba(7,12,32,0.5)" },
  ...
  h1: { margin: 0, fontSize: "clamp(42px,6.8vw,64px)", lineHeight: 1.0, letterSpacing: "-0.5px" },
  ...
  heroLink: { textDecoration: "none", background: "#f8fafc", color: "#111827", border: "1px solid #d1d5db", borderRadius: 8, padding: "10px 12px", fontWeight: 700, minWidth: 118, textAlign: "center", boxShadow: "inset 0 1px 0 rgba(255,255,255,0.7)" },
  ...
  metricCard: { background: "linear-gradient(180deg,#0a132d,#091127)", border: "1px solid #22314e", borderRadius: 14, padding: 14, minHeight: 98, display: "grid", alignContent: "end", boxShadow: "0 6px 18px rgba(5,10,28,.35)" },
  ...
  panel: { background: "radial-gradient(600px 260px at 50% 100%,rgba(30,58,138,.16),transparent 70%), #091127", border: "1px solid #22314e", borderRadius: 14, padding: 14, boxShadow: "0 8px 26px rgba(4,8,24,.45)" },
